{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNOg4zTiopLgMbsayjhe8NB",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/vitoriaayres/PYTHON.EXERCICIOS/blob/main/ALGORITMOSAVAN%C3%87ADOS.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "get_ipython().system('jupyter nbconvert --to script ALGORITMOSAVANÇADOS.ipynb')"
      ],
      "metadata": {
        "id": "7KzQ2aEjTiOd"
      },
